        ...
        if (column.key === 'product') {
            return (
                <div className="flex items-center">
                    <img className="h-8 w-8 rounded-md object-cover mr-3" src={row.image || '/path/to/default-image.png'} alt="product" />
            ...
            return (
                <div className="flex items-center">
                   <img
                        ...
                        src={row.image || '/path/to/default-image.png'}
                        alt="product"
                        onError={(e: any) => e.target.src = '/path/to/default-image.png'}
                    />
...
<path d="M6.80866 16.8125L5.30449 14.2792L2.45449 13.6458L2.73158 10.7167L0.791992 8.5L2.73158 6.28333L2.45449 3.35417L5.30449 2.72083L6.80866 0.1875L9.50033 1.33542L12.192 0.1875L13.6962 2.72083L16.5462 3.35417L16.2691 6.28333L18.2087 8.5L16.2691 10.7167L16.5462 13.6458L13.6962 14.2792L12.192 16.8125L9.50033 15.6646L6.80866 16.8125ZM7.48158 14.7938L9.50033 13.9229L11.5587 14.7938L12.667 12.8938L14.8441 12.3792L14.6462 10.1625L16.1107 8.5L14.6462 6.79792L14.8441 4.58125L12.667 4.10625L11.5191 2.20625L9.50033 3.07708L7.44199 2.20625L6.33366 4.10625L4.15658 4.58125L4.35449 6.79792L2.88991 8.5L4.35449 10.1625L4.15658 12.4187L6.33366 12.8938L7.48158 14.7938ZM8.66908 11.3104L13.142 6.8375L12.0337 5.68958L8.66908 9.05417L6.96699 7.39167L5.85866 8.5L8.66908 11.3104Z" fill="white"/>
    ...
    return (
        <div className='overflow-x-auto text-nowrap'>
            <table className="overflow-hidden rounded-lg Table_Uses_All w-full">
